    ...
    return (
        <div>
            ...
            onClick={()=>{countRef.current=countRef.current+1;alert(countRef.current)}}>
                Count with Ref variable</button>
            <input type="text" placeholder='Please fill' className='block text-gray-900 next-sm rounded=lg
            p-2 m-2 bg-purole-50 ring-1 ring-inset ring-purple-400
